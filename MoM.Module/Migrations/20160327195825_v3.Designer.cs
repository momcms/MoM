...
namespace MoM.Module.Migrations
{
    ...
    partial class v3
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("MoM.Module.Models.SiteSetting", b =>
                {
                    ...
                    b.Property<string>("SelectedThemeInModule");

                    b.Property<int?>("SelectedThemeModuleModuleId");

                    b.Property<bool>("UseLogo");

                    b.Property<bool>("UseSvgLogo");

                    b.HasKey("SiteSettingId");

                    b.HasAnnotation("Relational:Schema", "Core");

                    b.HasAnnotation("Relational:TableName", "SiteSetting");
                });
            ...
            modelBuilder.Entity("MoM.Module.Models.SiteSetting", b =>
                {
                    b.HasOne("MoM.Module.Models.Module")
                        .WithMany()
                        .HasForeignKey("SelectedThemeModuleModuleId");
                });
        }
    }
}
