    ...
    public partial class v8 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddColumn<int>(
                name: "NavigationMenuNavigationMenuId",
                schema: "Core",
            ...
            migrationBuilder.AddForeignKey(
                ...
                onDelete: ReferentialAction.Cascade);
            migrationBuilder.AddForeignKey(
                name: "FK_NavigationMenuItem_NavigationMenu_NavigationMenuNavigationMenuId",
                schema: "Core",
                table: "NavigationMenuItem",
                column: "NavigationMenuNavigationMenuId",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_PostTag_Post_PostId", schema: "Blog", table: "PostTag");
            migrationBuilder.DropForeignKey(name: "FK_PostTag_Tag_TagId", schema: "Blog", table: "PostTag");
            migrationBuilder.DropForeignKey(name: "FK_NavigationMenuItem_NavigationMenu_NavigationMenuNavigationMenuId", schema: "Core", table: "NavigationMenuItem");
            migrationBuilder.DropColumn(name: "NavigationMenuNavigationMenuId", schema: "Core", table: "NavigationMenuItem");
            migrationBuilder.DropColumn(name: "SortOrder", schema: "Core", table: "NavigationMenuItem");
