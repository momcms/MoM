    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    Logger.LogInformation(1, "Employee logged in.");
                ...
                {
                    Logger.LogWarning(2, "Employee account locked out.");
                    return View("Lockout");
                }
                else
                {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    Logger.LogInformation(3, "Employee created a new account with password.");
        ...
        public async Task<IActionResult> LogOff()
        {
            ...
            Logger.LogInformation(4, "Employee logged out.");
            return RedirectToAction(nameof(HomeController.Index), "Home");
        }
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null)
        {
            ...
            if (result.Succeeded)
            {
                Logger.LogInformation(5, "Employee logged in with {Name} provider.", info.LoginProvider);
                return RedirectToLocal(returnUrl);
            }
            if (result.RequiresTwoFactor)
            {
        ...
        public async Task<IActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            if (result.IsLockedOut)
            {
                Logger.LogWarning(7, "Employee account locked out.");
                return View("Lockout");
            }
            else
            {
